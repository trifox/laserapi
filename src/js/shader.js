...
const init = function () {
    ...
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array([
        ...
        -1, 0, laserApiConfig.transform.topleft.x, laserApiConfig.transform.topleft.y,
        1, 0, laserApiConfig.transform.topright.x, laserApiConfig.transform.topright.y,
        -1, 1, laserApiConfig.transform.bottomleft.x, laserApiConfig.transform.bottomleft.y,

        1, 1, laserApiConfig.transform.bottomright.x, laserApiConfig.transform.bottomright.y,
        1, 0, laserApiConfig.transform.topright.x, laserApiConfig.transform.topright.y,
        -1, 1, laserApiConfig.transform.bottomleft.x, laserApiConfig.transform.bottomleft.y
